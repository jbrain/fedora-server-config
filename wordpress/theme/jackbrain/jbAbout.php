    ...
    <div id="content" class="hfeed">
        ...
        <section id="entropy-study" class="entropy-study">
            ...
            <dialog id="entropy-methodology" class="entropy-study__dialog" aria-labelledby="entropy-methodology-heading">
                <h3 id="entropy-methodology-heading">Methodology</h3>
                <p>This is a transparent novelty heuristic, not a measurement of cryptographic key strength. Committed layer turns earn limited credit when their directed move, transition, coarse timing bin, or coarse gesture category has not appeared earlier in the session. Repetition stops adding credit; whole-cube rotations provide digest context but add no demo bits.</p>
                <p>The subtotal is discounted by 50% and capped at 32 demo bits. These are conservative display rules, not a NIST entropy-source validation. A fresh 128-bit public salt and the normalized move transcript are processed locally with SHA-256 through the browser Web Crypto API. No interaction data is stored or uploaded.</p>
                <p class="entropy-study__sources">Supporting references:</p>
                <ul>
