<?php
/**
 * @var array $attributes Block attributes (headingLevel, showArt, limit).
 */
...
printf(
	...
	Renderer::render_recent( $args ), // phpcs:ignore WordPress.Security.EscapeOutput -- Renderer output is already escaped.
	Blocks::editor_status_line( 'recent' ) // phpcs:ignore WordPress.Security.EscapeOutput -- already escaped.
);
